...
export const env = createEnv({
  ...
  server: {
    ...
    EXO_POD_REQUEST_CPU: z.string().default("250m"),
    EXO_POD_REQUEST_MEMORY: z.string().default("4Gi"),
    EXO_POD_LIMIT_MEMORY: z.string().default("8Gi"),
  ...
  runtimeEnv: {
    ...
    EXO_POD_REQUEST_CPU: process.env.EXO_POD_REQUEST_CPU,
    EXO_POD_REQUEST_MEMORY: process.env.EXO_POD_REQUEST_MEMORY,
    EXO_POD_LIMIT_MEMORY: process.env.EXO_POD_LIMIT_MEMORY,
